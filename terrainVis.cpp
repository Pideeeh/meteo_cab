...
int main(int, char* [])
{
	...
	// ----------------------------------------------------------------
	std::ifstream myfile("C:/Users/annik/Documents/fs22/scientific visualization/vis22_prog/meteo_cab/data/height_values.txt");
	if (!myfile.is_open())
	{
	...
	reader->SetFileName("C:/Users/annik/Documents/fs22/scientific visualization/vis22_prog/meteo_cab/data/heightfield.obj");
